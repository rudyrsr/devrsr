        ...
        stage('Image push images')
        {
            ...
            steps{
                script{
                    ...
                    sh "docker rmi  192.168.137.10:8082/repository/docker-images/back-prueba:latest | true; cd /data/publish/ ; docker build -t 192.168.137.10:8082/repository/docker-images/back-prueba:latest ."
