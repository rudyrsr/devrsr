...
pipeline{
	...
	environment{
       EMAIL_RECIPIENTS= 'rudyrsrcursos@gmail.com'
       EMAIL_RECIPIENTS_SUPPORT= 'rudyrsrcursos@gmail.com'
    }
    stages{
	...
	post {
		...
		failure {
		    sendEmail("failed","${EMAIL_RECIPIENTS_SUP}","${low_vp}","${medium_vp}","${high_vp}","${critical_vp}")
		}
	}
}
